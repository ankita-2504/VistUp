			...
			<body>
						...
						<div class="main-panel">
							...
							<div class="content-wrapper">
								...
								<div class="page-header">
									...
									<h3 class="page-title"> OPD Daily Transactions </h3>
												...
												<div class="row">
													...
													<div class="col-md-4">
														...
														<div class="form-group">
															...
															<input type="date" class="form-control" name="from" id="from" placeholder="Name" value="<?php $month = date('m');$day = date('d');$year = date('Y');$today = $year . '-' . $month . '-' . $day; echo $today; ?>"required>
													...
													<div class="col-md-4">
														...
														<div class="form-group">
															...
															<input type="date" class="form-control" name="to" id="to" placeholder="Name" value="<?php $month = date('m');$day = date('d');$year = date('Y');$today = $year . '-' . $month . '-' . $day; echo $today; ?>" required>
									...
									div.style.visibility = 'hidden';
											var n=document.getElementById("from").value;
																	...
																	({
																		...
																		url: "opd_transaction_show_onclick.php",
											...
											<div class="cs-container">
												<div class="cs-invoice cs-style1">
													<div class="cs-invoice_in" id="download_section">
													    ...
													    <div class="row">
													        <div class="col-md-12">
														        <h3 class="text-center" align="center">Opd Daily Transactions</h3>
													        </div>
													    </div>
														<div id="daily"></div>
				...
				<script>							
					...
					function printpage() 
					{
						...
						var pay=document.getElementById("ddlCountry").value;
						...
						({
							...
							url: "opd_daily_print.php",

							data: {to:to,from:from,pay:pay,doc:doc},
